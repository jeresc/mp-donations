  ...
  return (
    <section className="container m-auto grid min-h-screen grid-rows-[auto,1fr,auto] bg-background px-4 font-sans antialiased">
      <header className="text-xl font-bold leading-[4rem]">
        <Link href="/">mp-donations</Link>
      </header>
      <main className="py-8">
        <section className="grid gap-12">
          <form action={donate} className="m-auto grid w-full max-w-lg gap-4 rounded-lg border p-4">
      ...
      <footer className="text-center leading-[4rem] opacity-70">
        © {new Date().getFullYear()} mp-donations
      </footer>
    </section>
  );
}
